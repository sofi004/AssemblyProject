...
DEF_EFEITO_ASTEROIDE_MAU:                       ; tabela que define a animação, da explosão,  do asteroide mau (cor, largura, altura, pixels)
    ...
    WORD 0, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, 0
    WORD COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO
    WORD COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO
    WORD COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO
    WORD 0, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, COR_PIXEL_AZUL_CLARO, 0
...
; para podermos utilizar R0 e para preservar R7
    ...
    ;seleciona asteroide que fez sonda explodir
    MOV R7,32
    ...
    MOV R7,4
    SUB R10, R7
    JMP continua_animacao_explosao
