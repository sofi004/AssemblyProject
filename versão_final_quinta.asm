...
explosão_princ:
    ...
    CMP     R4, R1
    JLT     explosão_bom                     ; responsavel pelo efeito de explosão
    RET
...
primeira_animação_bom: 
    ADD     R8, 1                               ; decrementa em 1 a linha, porque a primeira animação começa a ser desenhada uma linha a baixo 
    ADD     R10, 1                              ; decrementa em 1 a coluna, porque a primeira animação começa a ser desenhada uma coluna a baixo
