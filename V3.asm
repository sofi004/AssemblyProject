...
move_sonda:
    ...
    POP     R5
    SHR     R11, 1                                  ; para voltar a ter o número do asteroide que explodiu
    ...
    PUSH R10
    PUSH R11
    MOV     R4, R11                             ; assim R4 fica com o valor do asteroide que explodiu
                                                ; ir buscar a posição do asteroide que explodiu à tabela
    ADD     R11, 1
    MOV     R6, R11
    MOV     [SELECIONA_ECRÃ], R6
    MOV     R5, posicao_asteroides              ; tabela que tem a posição dos asteroide no momento
    SHL     R4, 2
    ADD     R5, R4
    MOV     R10, [R5]
    SUB     R5, 2
    ...
    MOV     R11, 0
    MOV     R9, DEF_ASTEROIDE_MAU               ; é indiferente ser o bom ou o mau porque ambos são 5x5
    CALL    desenha_apaga_boneco
