...
; algumas destas mudanças de fase servem somente para que o valor em R0 não seja 1, quando não queremos que sejam desenhados o asteroide, a nave e a sonda nos respetivos locais de inicialização
